...
from .views import (
    ContractorsList, ContractorCreate, ContractorUpdate, ContractorDelete, ContractorSearch,
    SuppliersList, SupplierCreate, SupplierUpdate, SupplierDelete, SupplierSearch,
    PersonnelList, PersonnelCreate, PersonnelUpdate, PersonnelDelete, PersonnelSearch,
    PartnersList, PartnersCreate, PartnersUpdate, PartnersDelete, PartnerSearch,
    BuyersSellersList, BuyersSellersCreate, BuyersSellersUpdate, BuyersSellersDelete, BuyersSellersSearch,
    OrdersList, OrdersCreate, OrdersUpdate, OrdersDelete, OrdersSearch,
    ConflictOrdersList, ConflictOrdersCreate, ConflictOrdersUpdate, ConflictOrdersDelete, ConflictOrdersSearch
)
...
urlpatterns = [
    ...
    path('contractors/page/<int:page>', ContractorsList.as_view(), name="contractors"),
    path('contractors/search', ContractorSearch.as_view(), name='contractors_search'),
    path('contractors/search/page/<int:page>', ContractorSearch.as_view(), name="contractors_search"),
    ...
    path('suppliers/page/<int:page>', SuppliersList.as_view(), name='suppliers'),
    path('suppliers/search', SupplierSearch.as_view(), name='suppliers_search'),
    path('suppliers/search/page/<int:page>', SupplierSearch.as_view(), name='suppliers_search'),
    ...
    path('personnel/page/<int:page>', PersonnelList.as_view(), name='personnel'),
    path('personnel/search', PersonnelSearch.as_view(), name='personnel_search'),
    path('personnel/search/page/<int:page>', PersonnelSearch.as_view(), name='personnel_search'),
    ...
    path('partners/page/<int:page>', PartnersList.as_view(), name='partners'),
    path('partners/search', PartnerSearch.as_view(), name='partners_search'),
    path('partners/search/page/<int:page>', PartnerSearch.as_view(), name='partners_search'),
    ...
    path('buyers_sellers/page/<int:page>', BuyersSellersList.as_view(), name='buyers_sellers'),
    path('buyers_sellers/search', BuyersSellersSearch.as_view(), name='buyers_sellers_search'),
    path('buyers_sellers/search/page/<int:page>', BuyersSellersSearch.as_view(), name='buyers_sellers_search'),
    ...
    path('orders/page/<int:page>', OrdersList.as_view(), name='orders'),
    path('orders/search', OrdersSearch.as_view(), name='orders_search'),
    path('orders/search/page/<int:page>', OrdersSearch.as_view(), name='orders_search'),
    ...
    path('conflict_orders/page/<int:page>', ConflictOrdersList.as_view(), name='conflict_orders'),
    path('conflict_orders/search', ConflictOrdersSearch.as_view(), name='conflict_orders_search'),
    path('conflict_orders/search/page/<int:page>', ConflictOrdersSearch.as_view(), name='conflict_orders_search'),
