...
urlpatterns = [
    ...
    path('contracts/page/<int:page>', ContractsList.as_view(), name='contracts'),
    path('contracts/search', ContractsSearch.as_view(), name='contracts_search'),
    path('contracts/search/page/<int:page>', ContractsSearch.as_view(), name='contracts_search'),
    ...
    path('proceedings/page/<int:page>', ProceedingsList.as_view(), name='proceedings'),
    path('proceedings/search', ProceedingsSearch.as_view(), name='proceedings_search'),
    path('proceedings/search/page/<int:page>', ProceedingsSearch.as_view(), name='proceedings_search'),
    ...
    path('agreements/page/<int:page>', AgreementsList.as_view(), name='agreements'),
    path('agreements/search', AgreementsSearch.as_view(), name='agreements_search'),
    path('agreements/search/page/<int:page>', AgreementsSearch.as_view(), name='agreements_search'),
    ...
    path('bank_receipts/page/<int:page>', BankReceiptsList.as_view(), name='bank_receipts'),
    path('bank_receipts/search', BankReceiptsSearch.as_view(), name='bank_receipts_search'),
    path('bank_receipts/search/page/<int:page>', BankReceiptsSearch.as_view(), name='bank_receipts_search'),
    ...
    path('condition_statements/page/<int:page>', ConditionStatementsList.as_view(), name='condition_statements'),
    path('condition_statements/search', ConditionStatementsSearch.as_view(), name='condition_statements_search'),
    path('condition_statements/search/page/<int:page>', ConditionStatementsSearch.as_view(), name='condition_statements_search'),
    ...
    path('registered_docs/page/<int:page>', RegisteredDocsList.as_view(), name='registered_docs'),
    path('registered_docs/search', RegisteredDocsSearch.as_view(), name='registered_docs_search'),
    path('registered_docs/search/page/<int:page>', RegisteredDocsSearch.as_view(), name='registered_docs_search'),
    ...
    path('official_docs/page/<int:page>', OfficialDocsList.as_view(), name='official_docs'),
    path('official_docs/search', OfficialDocsSearch.as_view(), name='official_docs_search'),
    path('official_docs/search/page/<int:page>', OfficialDocsSearch.as_view(), name='official_docs_search'),
