...
from .views import (
    ChequesList, ChequesCreate, ChequesUpdate, ChequesDelete, ChequesSearch,
    FundList, FundCreate, FundUpdate, FundSearch, FundDelete,
    ReceivePayList, ReceivePayCreate, ReceivePayUpdate, ReceivePayDelete, ReceivePaySearch,
    CashBoxList, CashBoxCreate, CashBoxUpdate, CashBoxDelete, CashBoxSearch
)
...
urlpatterns = [
    ...
    path('cheques/page/<int:page>', ChequesList.as_view(), name='cheques'),
    path('cheques/search', ChequesSearch.as_view(), name='cheques_search'),
    path('cheques/search/page/<int:page>', ChequesSearch.as_view(), name='cheques_search'),
    ...
    path('receive_pays/page/<int:page>', ReceivePayList.as_view(), name='receive_pays'),
    path('receive_pays/search', ReceivePaySearch.as_view(), name='receive_pays_search'),
    path('receive_pays/search/page/<int:page>', ReceivePaySearch.as_view(), name='receive_pays_search'),
    ...
    path('funds/page/<int:page>', FundList.as_view(), name='funds'),
    path('funds/search', FundSearch.as_view(), name='funds_search'),
    path('funds/search/page/<int:page>', FundSearch.as_view(), name='funds_search'),
    ...
    path('cash_boxes/page/<int:page>', CashBoxList.as_view(), name='cash_boxes'),
    path('cash_boxes/search', CashBoxSearch.as_view(), name='cash_boxes_search'),
    path('cash_boxes/search/page/<int:page>', CashBoxSearch.as_view(), name='cash_boxes_search'),
